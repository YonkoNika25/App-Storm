...
class StormApp:
    ...
    def create_widgets(self):
        ...
        self.btn_storms_by_year = tk.Button(self.root, text="Thống kê số cơn bão theo từng năm", command=self.view_storms_by_year)
        self.btn_storms_by_year.pack(pady=10)

        self.btn_storms_by_month = tk.Button(self.root, text="Thống kê số cơn bão theo từng tháng", command=self.view_storms_by_month)
        self.btn_storms_by_month.pack(pady=10)

        self.btn_storm_address = tk.Button(self.root, text="Thống kê vị trí các cơn bão", command=self.view_storm_path)
    ...
    #đảm bảo chỉ có một cơn bão được chọn
    ...
    #xác nhận cơn bão được chọn và chuyển sang bước chọn biến
    ...
    #đảm bảo chỉ có một file negative được chọn             
    ...
    #đảm bảo chỉ có một biến được chọn   
    ...
    #tìm tên biến khi biết ý nghĩa của biến    
    ...
    #hàm này được gọi nếu người dùng chọn chức năng 'Phân tích xu hướng các biến theo năm'
    ...
    #hàm này được gọi nếu người dùng chọn chức năng "Thống kê số cơn bão theo từng năm"
    ...
    #hàm này được gọi nếu người dùng chọn chức năng "Thống kê số cơn bão theo từng tháng"
    ...
    #hàm này được gọi nếu người dùng chọn chức năng "Thống kê vị trí các cơn bão"
